    ...
    <div className="flex min-h-[calc(100vh-3.5rem)] flex-col bg-background">
      <div className="border-b border-border/40 px-6 py-5">
        ...
        <h1 className="mt-1 text-base font-semibold">
          Instagram Connector Workspace
        </h1>
        <p className="mt-1 text-xs text-muted-foreground">
          Instagram uses your Meta connection. Activate Facebook once and Operon
          AI can run IG campaign workflows.
        </p>
      </div>
          ...
          <div className="grid min-h-screen gap-4 lg:grid-cols-2">
            <div className="flex min-h-168 flex-col rounded-2xl border border-border/70 bg-card/70 p-6">
              ...
              <p className="mt-2 text-sm text-muted-foreground">
                When Meta is connected, Instagram placements and ad delivery
                controls become available automatically.
              </p>
            ...
            <div className="flex min-h-168 flex-col rounded-2xl border border-border/70 bg-card/70 p-6">
              ...
              <p className="mt-2 text-sm text-muted-foreground">
                After connection, tell Operon AI what you want and it will
                execute from strategy to optimization.
              </p>
              ...
              <div className="mt-5 space-y-3 text-sm text-foreground">
                ...
                <div className="rounded-xl border border-emerald-300/40 bg-emerald-50/40 p-4 text-emerald-700 dark:border-emerald-500/40 dark:bg-emerald-500/10 dark:text-emerald-300">
                  <div className="inline-flex items-center gap-1.5 font-medium">
                    ...
                    {status.connected
                      ? "AI control ready"
                      : "Connect Meta to unlock AI control"}
                  </div>
              ...
              <div className="mt-auto pt-6">
                <div className="rounded-xl border border-border/70 bg-background/90 p-4">
                  ...
                  <p className="text-sm text-foreground">
                    &quot;Create 3 Instagram ad sets for our summer offer,
                    budget split by audience intent, then pause low-CTR sets
                    after 48 hours.&quot;
                  </p>
                </div>
              </div>
